...
export class PacienteService {
  ...
  consultarGrupo(): Promise<any> {
   ...
   return this.http.get('https://app.divinaprovidencia.org.br/hdp-api/paciente/grupo/' + teste)
  ...
  consultaResumo(atend): Promise<any> {
    ...
    const teste = this.auth.jwtPayload.cod;
     return this.http.get(`https://app.divinaprovidencia.org.br/hdp-api/rpaciente/?x=${teste}&atend=${atend}`)
  ...
  consultarGrupoRisco(): Promise<any> {
    ...
    const teste = this.auth.jwtPayload.grupo;
    return this.http.get('https://app.divinaprovidencia.org.br/hdp-api/paciente/grupo/risco/' + teste)
...
return this.http.get('https://app.divinaprovidencia.org.br/hdp-api/paciente/setor/' + setor)
...
//    return this.http.get('http://localhost:8080/paciente/setor/' + setor)
  ...
  consultarCoremanejo(): Promise<any> {
   ...
   return this.http.get('https://app.divinaprovidencia.org.br/hdp-api/paciente/coremanejo/' + teste)
 // return this.http.get('http://localhost:8080/paciente/coremanejo/' + teste)
  ...
  consultarSolicitacoes(): Promise<any> {
   ...
   return this.http.get('https://app.divinaprovidencia.org.br/hdp-api/aval/' + teste)
 // return this.http.get('http://localhost:8080/aval/' + teste)
      .toPromise();
  }
 consultaTxtAval(x: string): Promise<any> {

 return this.http.get('https://app.divinaprovidencia.org.br/hdp-api/aval/sol/' + x)
 ...
 return this.http.get('https://app.divinaprovidencia.org.br/hdp-api/pacprot')
