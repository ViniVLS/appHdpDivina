...
export class AuthService {
  ...
  //oauthTokenUrl = 'http://localhost:8080/oauth/token';
   oauthTokenUrl = 'https://app.divinaprovidencia.org.br/hdp-api/oauth/token';
 ...
 .append('Authorization', 'Basic YW5ndWxhcjpAbmd1bEByMA==');
  ...
  // const encodedString = btoa(senha);
...
.catch(response => {
  ...
  solicitacaoSenha(cpf: string, email: string): Promise<any> {
    ...
    return this.http.put('https://app.divinaprovidencia.org.br/hdp-api/senha/1515', this.user)
   .toPromise();
...
consultaNotificacao(seq: string): Promise<any> {
 ...
 return this.http.get('https://app.divinaprovidencia.org.br/hdp-api/appaplic/' + seq)
    .toPromise();
}
